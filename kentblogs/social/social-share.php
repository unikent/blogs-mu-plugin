	...
	<div class=wrap>
		...
		<table class="form-table">
			...
			<tr>
				<th></th>
				<td>
					<label for="kb_social_sharing_homepage"><input type='checkbox' name="kb_social_sharing_homepage" value="show" <?php echo ($kb_social_sharing_homepage == "show")?'checked="checked"':''; ?>>Show sharing buttons globally</label>
				</td>
			</tbody>
		</table>
	</div>
