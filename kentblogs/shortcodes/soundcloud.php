 ...
 */
function kentblogs_soundcloud_embed_reversal( $content ) {
	...
	*/
	...
	foreach ( $regexes as $regex ) {
		...
		foreach ( $matches as $match ) {
			...
			do_action( 'kentblogs_embed_to_shortcode', 'soundcloud', $url_matches[0] );
		}
	}
...
add_filter( 'pre_kses', 'kentblogs_soundcloud_embed_reversal' );