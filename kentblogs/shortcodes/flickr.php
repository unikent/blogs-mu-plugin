...
function flickr_embed_to_shortcode( $content ) {
	...
	foreach ( array( 'regexp', 'regexp_ent' ) as $reg ) {
		...
		foreach ( $matches as $match ) {
			...
			do_action( 'kentblogs_embed_to_shortcode', 'flickr_video', $flashvars['photo_id'] );
		}
	}
...
wp_embed_register_handler( 'flickr', '#https?://(www\.)?flickr\.com/.*#i', 'kentblogs_flickr_oembed_handler' );

function kentblogs_flickr_oembed_handler( $matches, $attr, $url ) {
